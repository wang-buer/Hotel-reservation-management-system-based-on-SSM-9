...
public interface JiudiankefangService extends IService<JiudiankefangEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<JiudiankefangEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<JiudiankefangEntity> wrapper);
    
    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<JiudiankefangEntity> wrapper);
}
